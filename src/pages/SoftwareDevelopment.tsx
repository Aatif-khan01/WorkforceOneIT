    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 backface-hidden rotate-y-180">
          <div className="h-full w-full p-5 rounded-2xl bg-accent shadow-lg flex flex-col justify-center items-center text-center overflow-hidden">
            <Icon size={32} className="text-accent-foreground mb-2 flex-shrink-0" />
            <h3 className="text-base font-bold mb-2 text-accent-foreground flex-shrink-0">{title}</h3>
            <p className="text-accent-foreground/90 text-xs leading-tight line-clamp-4">
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 backface-hidden rotate-y-180">
          <div className="h-full w-full p-5 rounded-2xl bg-accent shadow-lg flex flex-col justify-center items-center text-center overflow-hidden">
            <div className="text-4xl font-bold text-accent-foreground/40 mb-2 flex-shrink-0">{number}</div>
            <h3 className="text-base font-bold mb-2 text-accent-foreground flex-shrink-0">{title}</h3>
...
const SoftwareDevelopment = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Custom Software Development | Workforce One Information Technology</title>
        <meta
          name="description"
          content="Build modern web, mobile, SaaS, and cloud platforms with Workforce One Information Technology—experts in agile development, DevOps, and quality engineering."
        />
        <meta
          name="keywords"
          ...
          <div className="hidden lg:flex lg:flex-col lg:items-center lg:justify-center max-w-7xl mx-auto space-y-8">
            ...
            <div className="relative w-32 h-32 flex items-center justify-center">
              <div className="w-28 h-28 bg-gradient-to-br from-primary to-accent clip-hexagon flex items-center justify-center transform hover:scale-110 transition-transform duration-300 shadow-xl">
                <Code size={40} className="text-primary-foreground" />
              </div>
            </div>
