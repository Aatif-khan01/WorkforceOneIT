...
const Booking = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Book a Consultation | Workforce One Information Technology</title>
        <meta
          name="description"
          content="Schedule a meeting with Workforce One Information Technology (WorkforceOneIT) to discuss proposal development, cleared recruitment, staffing, or software initiatives."
        />
        <meta
          name="keywords"
          content="Workforce One Information Technology, WorkforceOneIT, Workforce One IT, book consultation, schedule staffing call, proposal consultation meeting"
        />
        <link rel="canonical" href="https://www.workforceoneit.com/booking" />
        <meta property="og:title" content="Book a Consultation | Workforce One Information Technology" />
        <meta
          property="og:description"
          content="Easily schedule time with Workforce One Information Technology (WorkforceOneIT) experts."
        />
        <meta property="og:url" content="https://www.workforceoneit.com/booking" />
        <meta property="og:image" content="https://www.workforceoneit.com/og-image.jpg" />
        <meta name="twitter:title" content="Book a Consultation | Workforce One Information Technology" />
        <meta
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="sr-only" style={{ position: 'absolute', width: '1px', height: '1px', padding: '0', margin: '-1px', overflow: 'hidden', clip: 'rect(0, 0, 0, 0)', whiteSpace: 'nowrap', border: '0' }}>
              Book a Consultation | Workforce One Information Technology | WorkforceOneIT | Workforce One IT
            </h1>
          ...
          <div className="grid md:grid-cols-[350px_1fr_300px] gap-6">
            ...
            <Card className="p-6 bg-card border-border">
              <div className="space-y-6">
                <div>
                  <h3 className="font-semibold text-lg mb-2">Workforce One Information Technology</h3>
