  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Schedule a meeting with Workforce One Information Technology to discuss proposal development, cleared recruitment, staffing, or software initiatives."
        />
        <meta
          name="keywords"
          content="book consultation Workforce One Information Technology, schedule staffing call, proposal consultation meeting"
        />
            ...
            <Card className="p-6 bg-card border-border">
              <div className="space-y-4">
                ...
                {selectedDate && selectedTime && (
                  <Button className="w-full mt-4 bg-accent hover:bg-accent/90 text-accent-foreground transition-all duration-300">
                    Confirm Booking
                  </Button>
                )}
              </div>
