        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="hidden lg:grid lg:grid-cols-3 gap-12 items-center max-w-7xl mx-auto">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-accent flex items-center justify-center flex-shrink-0">
                    <span className="w-2.5 h-2.5 rounded-full bg-background"></span>
                  </div>
            ...
            <div className="flex flex-col items-center space-y-8">
              ...
              <div className="relative w-80 h-80">
                ...
                <div className="absolute top-1/2 right-0 -translate-y-1/2 w-28 h-28 bg-gradient-to-br from-primary to-accent clip-hexagon flex items-center justify-center transform hover:scale-110 transition-transform duration-300 shadow-xl">
                  <Briefcase size={36} className="text-primary-foreground" />
                </div>
                
                {/* Bottom Hexagon - Users */}
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-28 h-28 bg-gradient-to-br from-primary to-accent clip-hexagon flex items-center justify-center transform hover:scale-110 transition-transform duration-300 shadow-xl">
                  <Users size={36} className="text-primary-foreground" />
                </div>
                
                {/* Left Hexagon - Code */}
                <div className="absolute top-1/2 left-0 -translate-y-1/2 w-28 h-28 bg-gradient-to-br from-primary to-accent clip-hexagon flex items-center justify-center transform hover:scale-110 transition-transform duration-300 shadow-xl">
                  <Code size={36} className="text-primary-foreground" />
                </div>
              </div>
            </div>
          ...
          <div className="lg:hidden text-center space-y-8 max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-2 gap-4 sm:gap-6 max-w-md mx-auto py-8">
              ...
              <div className="w-24 h-24 sm:w-28 sm:h-28 mx-auto bg-gradient-to-br from-primary to-accent clip-hexagon flex items-center justify-center shadow-xl">
                <Users size={32} className="text-primary-foreground sm:w-10 sm:h-10" />
              </div>
              <div className="w-24 h-24 sm:w-28 sm:h-28 mx-auto bg-gradient-to-br from-primary to-accent clip-hexagon flex items-center justify-center shadow-xl">
                <Code size={32} className="text-primary-foreground sm:w-10 sm:h-10" />
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8 mb-16">
            {services.map((service, index) => (
              <Link key={index} to={service.link} className="group">
                <GlassCard className="p-0 h-full overflow-hidden transition-all duration-500 hover:scale-105 hover:bg-accent hover:border-accent">
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <GlassCard className="p-8 sm:p-12 md:p-16 text-center">
            ...
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-6 md:mb-8 max-w-2xl mx-auto">
              Whether you're preparing to win your next contract, staffing up for growth, or building a digital platform for the future, Workforce One Information Technology is ready.
            </p>
            <Link to="/contact">
              <Button size="lg" className="bg-accent hover:bg-accent/90 hover:shadow-lg text-accent-foreground text-base md:text-lg px-8 sm:px-12 py-5 md:py-6 group w-full sm:w-auto transition-all duration-300">
                Get in Touch
