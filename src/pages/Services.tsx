...
const Services = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Professional Services | Workforce One Information Technology</title>
        <meta
          name="description"
          content="Explore Workforce One Information Technology (WorkforceOneIT) services spanning proposal development, cleared recruitment, workforce staffing, and custom software development."
        />
        <meta
          name="keywords"
        ...
        <meta
          ...
          content="One partner for proposal strategy, cleared talent, workforce staffing, and software delivery with Workforce One Information Technology (WorkforceOneIT)."
        />
        <meta property="og:url" content="https://www.workforceoneit.com/services" />
        <meta property="og:image" content="https://www.workforceoneit.com/og-image.jpg" />
        <meta name="twitter:title" content="Services | Workforce One Information Technology" />
        <meta
          ...
          <div className="hidden lg:grid lg:grid-cols-3 gap-12 items-center max-w-7xl mx-auto">
            ...
            <div className="flex flex-col items-center space-y-8">
              ...
              <h1 className="sr-only" style={{ position: 'absolute', width: '1px', height: '1px', padding: '0', margin: '-1px', overflow: 'hidden', clip: 'rect(0, 0, 0, 0)', whiteSpace: 'nowrap', border: '0' }}>
                Our Services | Workforce One Information Technology | WorkforceOneIT | Workforce One IT
              </h1>
