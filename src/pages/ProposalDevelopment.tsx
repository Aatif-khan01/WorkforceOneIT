...
const ProposalDevelopment = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Proposal Development Services | Workforce One Information Technology</title>
        <meta
          name="description"
          content="Win federal and commercial bids with capture planning, proposal writing, graphics, compliance, and project management from Workforce One Information Technology."
        />
        <meta
          name="keywords"
