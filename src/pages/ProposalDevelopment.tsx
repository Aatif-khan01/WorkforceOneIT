...
const ProposalDevelopment = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Proposal Development | Workforce One Information Technology</title>
        <meta
          name="description"
        ...
        />
        <meta property="og:url" content="https://www.workforceoneit.com/services/proposal" />
        <meta property="og:image" content="https://www.workforceoneit.com/og-image.jpg" />
        <meta name="twitter:title" content="Proposal Development | Workforce One Information Technology" />
        <meta
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="hidden lg:flex lg:flex-col lg:items-center lg:justify-center max-w-7xl mx-auto space-y-8">
            ...
            <h1 className="sr-only" style={{ position: 'absolute', width: '1px', height: '1px', padding: '0', margin: '-1px', overflow: 'hidden', clip: 'rect(0, 0, 0, 0)', whiteSpace: 'nowrap', border: '0' }}>
              Proposal Development | Workforce One Information Technology | WorkforceOneIT | Workforce One IT
            </h1>
            <h2 className="text-5xl md:text-6xl font-bold text-center">Proposal Development</h2>
          ...
          <div className="lg:hidden text-center space-y-8 max-w-3xl mx-auto">
            ...
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold">Proposal Development</h2>
