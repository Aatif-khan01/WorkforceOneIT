...
<Button
 size="lg"
 className="w-full group bg-accent hover:bg-accent/90 hover:shadow-lg hover:scale-105 text-accent-foreground text-base sm:text-lg px-6 sm:px-8 py-5 sm:py-6 transition-all duration-300"
>
Get Started
...
<AnimatedCard
className="p0 h-full overflow-hidden transition-all duration-500 hover:scale-105 hover:bg-accent hover:border-accent"
animation="fadeInUp"
delay={index * 50}
hover={false}
>
...
<div className="flex items-center text-accent group-hover:translate-x-2 transition-all duration-500 group-hover:text-accent-foreground">
...
<div className="text-5xl font-extrabold text-accent mb-4 animate-float">01</div>
...
<div className="text-5xl font-extrabold text-accent mb-4 animate-float" style={{animationDelay: '1s'}}>
03
</div>
...
<Button
size="lg"
className="bg-accent hover:bg-accent/90 hover:shadow-lg text-accent-foreground text-lg px-12 py-6 group transition-all duration-300"
>
Start Your Journey
<ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" />
</Button>
