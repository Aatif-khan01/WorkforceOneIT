    ...
    <>
      <Helmet>
        ...
        <meta
          ...
          content="Accelerate contract wins, talent acquisition, and digital transformation with Workforce One Information Technology (WorkforceOneIT)."
        />
      ...
      <div className="min-h-screen">
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 md:pt-20">
          ...
          <h1 className="sr-only">
            Workforce One Information Technology | WorkforceOneIT | Workforce One IT
          </h1>
          <h2 className="sr-only">
            Empowering Your Mission with Talent & Strategy
          </h2>
