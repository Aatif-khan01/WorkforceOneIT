...
const Home = () => {
  ...
  useEffect(() => {
    const seen = sessionStorage.getItem("christmas-popup-seen");
    if (!seen) {
  ...
  const services = [
    {
      ...
      description:
        "Accelerating your success in federal contracting through Strategic Proposal Development.",
    ...
    },
    {
      ...
      description:
        "Accelerated access to highly qualified and cleared professionals for your mission-critical projects.",
    ...
    },
    {
      ...
      description:
        "Connecting your business with thoroughly vetted talent that fits your culture and mission.",
    ...
    },
    {
      ...
      description:
        "Custom software development that accelerates your market growth and competitive advantage.",
  ...
  return (
    <>
      <Helmet>
        <title>
          Workforce One Information Technology | Proposal Development, Recruitment & Software
        </title>
        <meta
          name="description"
        ...
        <meta
          ...
          content="Accelerate contract wins, talent acquisition, and digital transformation with Workforce One Information Technology."
        />
      ...
      <div className="min-h-screen relative">
        ...
        {showChristmasPopup && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
            <div className="relative w-[90%] max-w-md rounded-2xl bg-gradient-to-br from-red-600 via-red-500 to-emerald-500 text-white shadow-2xl border border-white/20 p-6 sm:p-8">
              <button
                onClick={() => setShowChristmasPopup(false)}
                className="absolute right-3 top-3 rounded-full bg-white/10 hover:bg-white/20 px-2 py-1 text-sm"
                aria-label="Close Christmas offer"
              >
                ✕
              </button>
              ...
              <div className="text-center space-y-3">
                ...
                <h2 className="text-2xl sm:text-3xl font-extrabold">
                  Merry Christmas from Workforce One!
                </h2>
                <p className="text-sm sm:text-base text-red-50">
                  Wishing you a successful new year filled with winning proposals, great talent, and
                  high‑impact projects. Ready to plan your next pipeline?
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-4 justify-center">
                  <Link to="/contact">
                    <Button
                      size="lg"
                      className="w-full sm:w-auto bg-white text-red-600 font-semibold hover:bg-yellow-100"
                      onClick={() => setShowChristmasPopup(false)}
                    >
            ...
            >
              <AnimatedCard className="p-8" animation="fadeInUp" delay={0}>
                ...
                <p className="text-muted-foreground">
                  Technology can optimize processes, but it's people who make them meaningful. We
                  use data-driven targeting and human expertise to deliver results that matter.
                </p>
              </AnimatedCard>

              <AnimatedCard className="p-8" animation="fadeInUp" delay={50}>
                <div
                  className="text-5xl font-bold text-secondary mb-4 animate-float"
                ...
                <p className="text-muted-foreground">
                  We deliver handpicked candidates, customized proposals, and software that aligns
                  with your exact requirements. Every solution is crafted with precision and care.
                </p>
              </AnimatedCard>

              <AnimatedCard className="p-8" animation="fadeInUp" delay={100}>
                <div
                  className="text-5xl font-bold text-coral mb-4 animate-float"
                ...
                <p className="text-muted-foreground">
                  Today, we help you meet deadlines. Tomorrow, we help you expand into new markets
                  and build a future-ready workforce equipped for tomorrow's challenges.
                </p>
              </AnimatedCard>
            </StaggeredAnimation>
          </div>
            ...
            <AnimatedCard className="p-12 max-w-4xl mx-auto" animation="fadeInUp" delay={50}>
              ...
              <div className="space-y-6">
                {values.map((value, index) => (
                  ...
                  >
                    <CheckCircle
                      className="text-accent flex-shrink-0 mt-1 animate-pulse-slow"
                      size={24}
                    />
              ...
              sections={[
                {
                  ...
                  content:
                    "Workforce One Information Technology is purpose built to empower organizations, from federal contractors to commercial enterprises, to thrive amidst rapid technological and business change. We serve as a strategic partner, delivering proven expertise, agility, and innovative solutions that drive measurable results for our clients. Our core capabilities encompass Proposal Development, Cleared Recruitment, Flexible Staffing Solutions, and Custom Software Development. We leverage these services to help you build high performing teams, optimize operational efficiency, and successfully achieve mission critical objectives with precision and commitment."
                },
                {
                  title: "Our Vision",
                  icon: <Zap size={24} className="text-background" />,
                  content:
                    "To be the premier workforce and strategic solutions provider, recognized globally for our commitment to excellence, innovation, and measurable results that consistently drive business success for our clients."
                },
                {
                  title: "Our Mission",
                  icon: <Shield size={24} className="text-background" />,
                  content:
                    "To bridge the gap between opportunity and execution by providing specialized talent, strategic insights (Proposal Development), and cutting-edge technology solutions that empower our clients to achieve their most critical objectives with confidence."
                }
              ]}
            />
          </div>
