...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
      <title>Contact Workforce One Information Technology | Start the Conversation</title>
        <meta
          name="description"
          content="Contact Workforce One Information Technology to discuss proposal support, cleared recruitment, staffing, and software development needs."
        />
        <meta
          name="keywords"
          content="contact Workforce One Information Technology, proposal consultation, staffing inquiry, software project quote"
        />
        <link rel="canonical" href="https://www.workforceonesolutions.com/contact" />
        <meta property="og:title" content="Contact Workforce One Information Technology" />
        <meta
        ...
        <meta name="twitter:title" content="Contact Workforce One Information Technology" />
        <meta
            ...
            Get in Touch
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button 
                  ...
                  size="lg" 
                  disabled={isSubmitting}
                  className="w-full bg-accent hover:bg-accent/90 hover:shadow-lg text-accent-foreground text-lg font-semibold py-7 group transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                >
