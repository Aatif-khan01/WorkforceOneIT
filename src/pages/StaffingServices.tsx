      ...
      <div className={`relative w-full h-full transition-transform duration-700 transform-style-3d ${isFlipped ? 'rotate-y-180' : ''}`}>
        ...
        <div className="absolute inset-0 backface-hidden rotate-y-180">
          <div className="h-full w-full p-6 rounded-2xl bg-accent shadow-lg flex flex-col justify-center items-center text-center overflow-hidden">
            <Icon size={40} className="text-accent-foreground mb-3 flex-shrink-0" />
...
const StaffingServices = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Workforce Staffing Services | Workforce One Information Technology</title>
        <meta
          name="description"
          content="Deploy pre-vetted commercial talent fast with Workforce One Information Technology staffing services covering contract, contract-to-hire, and direct placements."
        />
        <meta
          name="keywords"
