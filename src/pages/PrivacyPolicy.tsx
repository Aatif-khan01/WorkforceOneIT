...
const PrivacyPolicy = () => {
  return (
    <>
      <Helmet>
        <title>Privacy Policy | Workforce One Information Technology</title>
        <meta
          name="description"
          content="Review Workforce One Information Technology's privacy practices covering confidentiality, data protection, and information handling standards."
        />
        <meta
          name="keywords"
          content="Workforce One Information Technology privacy policy, data protection, confidentiality statement"
        />
        <link rel="canonical" href="https://www.workforceonesolutions.com/privacy-policy" />
        <meta property="og:title" content="Privacy Policy" />
        <meta
          property="og:description"
          content="Understand how Workforce One Information Technology safeguards your data."
        />
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-20 bg-gradient-to-b from-background to-background/50">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            <div className="inline-block p-4 rounded-2xl bg-accent mb-4">
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <GlassCard className="p-8 md:p-12">
              ...
              <p className="text-lg text-foreground leading-relaxed">
                At Workforce One Information Technology, ensuring your privacy and the confidentiality of all information is our paramount commitment. We are dedicated to maintaining the highest standards of data protection and ethical information handling.
              </p>
            </GlassCard>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <GlassCard className="p-8 group hover:border-accent transition-colors">
                  <div className="flex items-start space-x-4">
                    <div className="p-3 rounded-xl bg-accent flex-shrink-0 group-hover:scale-110 transition-transform">
                      <Lock size={24} className="text-background" />
                    </div>
                    <div>
                      <h3 className="text-xl font-bold mb-3 text-foreground">Confidentiality First</h3>
                      <p className="text-muted-foreground">
                        The confidentiality of any and all information we may possess about you is of prime importance to Workforce One Information Technology.
                      </p>
                    </div>
                  </div>
                </GlassCard>
            ...
            <GlassCard className="p-8 md:p-12 bg-accent/5">
              <h2 className="text-3xl font-bold mb-6 text-foreground">
                Website Information Gathering
              </h2>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-foreground leading-relaxed">
                    Like most websites, Workforce One Information Technology may use common internet technologies, such as cookies and server logs, to collect general, non-personal information while you browse our website. This information is typically technical and aggregated.
                  </p>
                </div>
            ...
            {/* Contact Section */}
            <GlassCard className="p-8 md:p-12 text-center bg-background/50">
              ...
              <a 
                href="/contact" 
                className="inline-flex items-center px-6 py-3 rounded-lg bg-accent hover:bg-accent/90 text-accent-foreground font-semibold transition-all duration-300 hover:shadow-lg"
              >
                Contact Us
              </a>
            </GlassCard>
