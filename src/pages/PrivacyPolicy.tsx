  ...
  return (
    <>
      <Helmet>
        ...
        />
        <link rel="canonical" href="https://www.workforceoneit.com/privacy-policy" />
        <meta property="og:title" content="Privacy Policy" />
        <meta
          property="og:description"
          content="Understand how Workforce One Information Technology safeguards your data."
        />
        <meta property="og:url" content="https://www.workforceoneit.com/privacy-policy" />
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <h1 className="sr-only" style={{ position: 'absolute', width: '1px', height: '1px', padding: '0', margin: '-1px', overflow: 'hidden', clip: 'rect(0, 0, 0, 0)', whiteSpace: 'nowrap', border: '0' }}>
              Privacy Policy | Workforce One Information Technology | WorkforceOneIT | Workforce One IT
            </h1>
