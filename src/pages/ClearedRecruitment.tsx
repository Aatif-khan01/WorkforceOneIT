      ...
      >
        ...
        <div className="absolute inset-0 backface-hidden rotate-y-180">
          <div className="h-full w-full p-6 rounded-2xl bg-accent shadow-lg flex flex-col justify-center items-center text-center overflow-hidden">
            <Icon className="w-12 h-12 mb-3 text-accent-foreground flex-shrink-0" />
            <h3 className="text-base font-bold mb-3 text-accent-foreground flex-shrink-0">{title}</h3>
            <p className="text-accent-foreground/90 text-xs leading-tight line-clamp-6">
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Back Side */}
        <div className="absolute inset-0 backface-hidden rotate-y-180">
          <div className="h-full w-full p-5 rounded-2xl bg-accent shadow-lg flex items-center justify-center text-center overflow-hidden">
            <p className="text-accent-foreground font-medium text-sm line-clamp-3 px-2">
...
const ClearedRecruitment = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Cleared Recruitment Services | Workforce One Information Technology</title>
        <meta
          name="description"
          content="Access fully vetted professionals with active security clearances, from Secret to TS/SCI with polygraph, through Workforce One Information Technology."
        />
        <meta
          name="keywords"
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="hidden lg:flex lg:flex-col lg:items-center lg:justify-center max-w-7xl mx-auto space-y-8">
            ...
            <div className="relative w-32 h-32 flex items-center justify-center">
              <div className="w-28 h-28 bg-gradient-to-br from-primary to-accent clip-hexagon flex items-center justify-center transform hover:scale-110 transition-transform duration-300 shadow-xl">
          ...
          <div className="lg:hidden text-center space-y-8 max-w-3xl mx-auto">
            ...
            <div className="flex justify-center">
              <div className="w-24 h-24 sm:w-28 sm:h-28 bg-gradient-to-br from-primary to-accent clip-hexagon flex items-center justify-center shadow-xl">
                <Shield size={32} className="text-primary-foreground sm:w-10 sm:h-10" />
              </div>
            </div>
...
Why Choose Our Cleared Recruitment
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-bold mb-2 text-accent">Compliance Assurance</h3>
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          <GlassCard className="p-16 text-center">
            ...
            <Link to="/contact">
              <Button size="lg" className="bg-accent hover:bg-accent/90 hover:shadow-lg text-accent-foreground text-lg px-12 py-6 group transition-all duration-300">
                Start Recruiting
