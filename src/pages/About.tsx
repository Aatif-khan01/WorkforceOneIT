...
const About = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About Workforce One Information Technology | Trusted Talent & Technology Partner</title>
        <meta
          name="description"
          content="Learn how Workforce One Information Technology empowers government contractors and commercial enterprises with proposal development, cleared staffing, and software expertise."
        />
        <meta
          name="keywords"
          content="about Workforce One Information Technology, proposal experts, cleared staffing partner, software consultancy"
        />
        <link rel="canonical" href="https://www.workforceonesolutions.com/about" />
        <meta property="og:title" content="About Workforce One Information Technology" />
        <meta
          property="og:description"
          content="Discover the mission, values, and team behind Workforce One Information Technology."
        />
        ...
        <meta name="twitter:title" content="About Workforce One Information Technology" />
        <meta
            ...
            <div className="space-y-6 md:space-y-8">
              <div className="space-y-4 md:space-y-6">
                ...
                <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
                  Workforce One Information Technology was founded with a clear purpose that is to empower
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-background to-background/50">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
            ...
            <GlassCard className="p-6 md:p-8">
              <div className="text-3xl md:text-4xl font-bold text-accent mb-3 md:mb-4">$$$</div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-wrap justify-center gap-5 md:gap-6 max-w-5xl mx-auto">
            {industries.map((industry, index) => (
              <div
                key={index}
                className="px-8 py-4 rounded-full border-[3px] border-border bg-background/50 backdrop-blur-sm hover:border-accent hover:bg-accent/10 transition-all duration-300 cursor-default shadow-md"
              >
