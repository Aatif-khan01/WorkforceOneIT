        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8 ml-auto">
            ...
            <Link to="/contact">
              <Button
                size="lg"
                className="bg-accent hover:bg-accent/90 hover:shadow-xl text-accent-foreground text-base font-semibold transition-all duration-300 hover:scale-105 px-8 py-6"
              >
                LET'S TALK
              </Button>
            </Link>
          ...
          {isOpen && (
            ...
            >
              ...
              <Link to="/contact" onClick={() => setIsOpen(false)}>
                <Button
                  size="lg"
                className="w-full bg-accent hover:bg-accent/90 hover:shadow-xl text-accent-foreground py-6 mt-4 transition-all duration-300 hover:scale-105 text-base font-semibold"
                >
                  LET'S TALK
                </Button>
              </Link>
