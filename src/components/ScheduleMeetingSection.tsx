          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="p-8 md:p-12">
              ...
              <div className="flex flex-wrap gap-4">
                <Link to="/booking">
                  <Button size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground gap-2 transition-all duration-300">
                    Schedule a Meeting
                    <ArrowRight className="w-4 h-4" />
                  </Button>
                </Link>
                <Link to="/contact">
                  <Button size="lg" variant="outline" className="gap-2 border-accent text-accent hover:bg-accent hover:text-accent-foreground transition-all duration-300">
                    Request a Callback
                    <ArrowRight className="w-4 h-4" />
                  </Button>
                </Link>
